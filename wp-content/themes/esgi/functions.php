...
if(is_admin()){
	...
	function contenu_description() {
		echo "<div class='parallax' style='background-image:url(wp-content/themes/esgi/img/The_Legend_of_Zelda_Breath_of_the_Wild-92.gif)'>";
		
		echo "<p class='parallax_content'>L’association Nintendo a pour but de rassembler des personnes appréciant cette grande firme vidéo-ludique.</p>";

		echo "</div>";
		echo "<div id='banniere'>";
			echo "<div id='banniere_img'><img src='wp-content/themes/esgi/img/13339691_10153504876831447_8787066014541689565_n.jpg'></div>";
